...
(pinky.SpineClusters & "cluster_id=1")
...
@schema
class ContactCorrelationAxon(dj.Computed):
    definition="""
    -> pinky.Segment
    ...
    def make(self,key):
        ...
        prepost_data = (pinky_fc.ContactPrePost & (pinky.SpineClusters & "cluster_id=1")).proj("postsyn","total_contact_conversion",
...
start_time = time.time()
ContactCorrelationAxon.populate()
