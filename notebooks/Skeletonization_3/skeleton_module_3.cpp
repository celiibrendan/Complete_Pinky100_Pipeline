...
static struct PyModuleDef calcification_Module_3 =
{
    PyModuleDef_HEAD_INIT,
    "calcification_Module_3",
    "CGAL Skeleton Module",
    -1,
    calcification_Methods
};

PyMODINIT_FUNC PyInit_calcification_Module_3(void )
{
    return PyModule_Create(&calcification_Module_3);
}
