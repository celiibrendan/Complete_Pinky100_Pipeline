...
ta3p100.Decimation35 & ta3p100.CurrentSegmentation & 'decimation_ratio=0.35' & pyramidal_cell_rel
...
class CleansedMesh(dj.Computed):
    ...
    key_source = ta3p100.Decimation35 & ta3p100.CurrentSegmentation & 'decimation_ratio=0.35' & pyramidal_cell_rel 
    ...
    def make(self, key):
        ...
        mesh = (ta3p100.Decimation35 & key).fetch1()
