...
class Decimation35ExcitatoryStitchedMesh(dj.Computed):
    ...
    def make(self, key):
        ...
        # Load mesh
        mesh = (pinky.ExcitatoryStitchedMeshVp2 & key).fetch1()
        ...
        self.insert1(dict(key,
                          ...
                          triangles=new_triangles),skip_duplicates=True)
...
start = time.time()
Decimation35ExcitatoryStitchedMesh.populate(reserve_jobs=True)
print(time.time() - start)
