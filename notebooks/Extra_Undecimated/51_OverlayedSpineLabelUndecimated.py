...
@schema
class OverlayedSpineLabelUndecimated(dj.Computed):
    definition = """
...
#(schema.jobs & "table_name='__overlayed_spine_label_undecimated'").delete()
...
start = time.time()
OverlayedSpineLabelUndecimated.populate(reserve_jobs=True)
