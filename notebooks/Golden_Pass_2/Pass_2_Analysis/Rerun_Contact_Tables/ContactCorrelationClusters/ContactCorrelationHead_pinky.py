...
(pinky.SpineClusters & "cluster_id=2")
...
@schema
class ContactCorrelationHead(dj.Computed):
    definition="""
    -> pinky.Segment
    ...
    def make(self,key):
        ...
        prepost_data = (pinky_fc.ContactPrePost & (pinky.SpineClusters & "cluster_id=2")).proj("postsyn","total_contact_conversion",
...
start_time = time.time()
ContactCorrelationHead.populate()
