...
//     //int j = make_skeleton();
//     //int j = check_closed();
//     //int j = clean_elephant();
//     //int j = skeletonization_with_pre();
    
//     //return j;
    
//     //*************start of regular make skeleton function here ****************//
...
//     std::string location = "/notebooks/Skeletonization/";
//     //std::string filename = "filled_cleaned_up"; //generted by mesh lab and doesn't work
//     std::string filename = "Voxelized_Mesh_Resurfaced.off"; //generted by mesh lab and doesn't work
...
//     std::string output_location = location;
