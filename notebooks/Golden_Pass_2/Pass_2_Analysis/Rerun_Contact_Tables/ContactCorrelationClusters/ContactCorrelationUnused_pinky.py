...
(pinky.SpineClusters & "cluster_id=4")
...
@schema
class ContactCorrelationUnused(dj.Computed):
    definition="""
    -> pinky.Segment
    ...
    def make(self,key):
        ...
        prepost_data = (pinky_fc.ContactPrePost & (pinky.SpineClusters & "cluster_id=4")).proj("postsyn","total_contact_conversion",
...
start_time = time.time()
ContactCorrelationUnused.populate()
